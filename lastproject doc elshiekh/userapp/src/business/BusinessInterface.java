...
public interface BusinessInterface extends Remote{
    ...
    public void tellOthersClientRegisteration(String mail, ArrayList<String> clientFriends)throws RemoteException;
    public void tellOthersClientUNREG(String mail, ArrayList<String> clientFriends)throws RemoteException;
